...
TIME_EPSILON = 1e-12
"""Absolute tolerance for comparing times on a model's native time axis.

Shared by pulse-value containment checks, scheduler placement, and solver
binding so those three never disagree about whether two instants coincide.
"""
