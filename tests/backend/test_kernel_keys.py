...
def test_lowering_copies_the_key_onto_the_step():
    ...
    steps = _lowered_gate_steps(SimulatorBackend(), program)
...
def test_custom_rule_lowers_with_no_key():
    ...
    backend = SimulatorBackend(implementation_map=custom_map)
...
def test_device_specific_rule_lowers_with_no_key():
    ...
    backend = SimulatorBackend(implementation_map=device_map)
