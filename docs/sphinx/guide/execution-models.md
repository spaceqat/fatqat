...
:::{tab-item} General simulator

The general {py:class}`~fatqat.simulator.Simulator` applies the logical gate
...
{py:class}`~fatqat.ResourceLayout` makes the binding explicit. [Testing a
