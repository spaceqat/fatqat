...
:class:`ReadoutConfusion` is a classical channel applied to the digit reported
...
:class:`~fatqat.RegisterRef` or device label. Correlated multi-operand
...
physical digit was measured. See :ref:`noise-simulator-support` for backend
...
a Lindblad operator. See :ref:`noise-emulator-support` for each emulator's
reported digit dimension and physical-level mapping.

API
---

.. autoclass:: ReadoutConfusion
